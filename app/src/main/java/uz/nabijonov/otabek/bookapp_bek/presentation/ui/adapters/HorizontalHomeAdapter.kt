...
import uz.nabijonov.otabek.bookapp_bek.databinding.ItemBookBinding
import javax.inject.Inject

class HorizontalHomeAdapter @Inject constructor() :
    Adapter<HorizontalHomeAdapter.ItemHolder>() {
